...
class MandelbrotSetTask extends Task<Long> {
    ...
    public MandelbrotSetTask(boolean parallel, PixelWriter pixelWriter, int width, int height,
                             double minR, double minI, double maxR, double maxI,
                             double minX, double minY, double maxX, double maxY, boolean fast) {
    ...
    static {
        Color[] cc = {
                Color.rgb(10, 0, 50),   // Изменён цвет
                Color.rgb(0, 255, 255), // Изменён цвет
                Color.rgb(255, 255, 0), // Изменён цвет
                Color.rgb(255, 0, 0),   // Оставлено
                Color.rgb(0, 0, 255),   // Изменён цвет
                Color.rgb(0, 255, 0),   // Оставлено
                Color.rgb(255, 0, 255)  // Изменён цвет
        };
